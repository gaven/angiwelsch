...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }(); // import isotope from 'isotope-layout';
	...
	var Grid = function () {
	  ...
	  _createClass(Grid, [{
	    ...
	    value: function duplicateImage() {
	      ...
	      var $items = $wrapper.find('.grid__item');

	      $items.each(function () {
	        var _this = this;

	        $(this).loaded(function () {
	          var $image = $(_this).find('.grid__image');
	        });
	      });
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function (window, factory) {
	  ...
	  if (true) {
	    // AMD
	    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(5)], __WEBPACK_AMD_DEFINE_RESULT__ = function (EvEmitter) {
